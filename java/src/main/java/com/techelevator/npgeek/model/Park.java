...
public class Park {
	...
	/**
	 * @return the annualVistorCOunt
	 */
	public int getAnnualVisitorCount() {
		return annualVisitorCount;
	}
	/**
	 * @param annualVistorCOunt the annualVistorCOunt to set
	 */
	public void setAnnualVisitorCount(int annualVistorCOunt) {
		this.annualVisitorCount = annualVistorCOunt;
	}
	/**
